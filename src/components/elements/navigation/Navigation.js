                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav text-center">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link" to="/models">MODEL-VIEWER</Link>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item">
                                <a className="nav-link" target="_blank" rel="noopener noreferrer" href="https://github.com/gainstrive/jsrpg-sandbox">GITHUB</a>
                            </li>
                        </ul>
                    </div>
                </nav>
